...
args = {
    "project_id": "hello-generic-demo-0327163628",
}

dag = DAG(
    "hello-generic-demo-0327163628",
    default_args=args,
...
op_bb889c69_b23a_484e_8fb3_e69309f38a98 = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "hello-generic-demo-{{ ts_nodash }}",
    },
    volumes=[],
    volume_mounts=[],
    secrets=[
