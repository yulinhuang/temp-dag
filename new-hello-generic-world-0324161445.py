...
args = {
    "project_id": "new-hello-generic-world-0324161445",
}

dag = DAG(
    "new-hello-generic-world-0324161445",
    default_args=args,
...
op_bb889c69_b23a_484e_8fb3_e69309f38a98 = KubernetesPodOperator(
    ...
    env_vars={
        ...
        "ELYRA_RUN_NAME": "new-hello-generic-world-{{ ts_nodash }}",
    },
    volumes=[],
    volume_mounts=[],
    secrets=[
