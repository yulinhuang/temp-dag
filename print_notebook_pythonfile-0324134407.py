...
args = {
    "project_id": "print_notebook_pythonfile-0324134407",
}

dag = DAG(
    "print_notebook_pythonfile-0324134407",
    default_args=args,
...
op_0b0bf262_bc90_4ece_b41b_042f002aef64 = KubernetesPodOperator(
    ...
    cmds=["sh", "-c"],
    arguments=[
        "mkdir -p ./jupyter-work-dir/ && cd ./jupyter-work-dir/ && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/main/elyra/airflow/bootstrapper.py' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/main/elyra/airflow/bootstrapper.py --output bootstrapper.py && echo 'Downloading https://raw.githubusercontent.com/elyra-ai/elyra/main/etc/generic/requirements-elyra.txt' && curl --fail -H 'Cache-Control: no-cache' -L https://raw.githubusercontent.com/elyra-ai/elyra/main/etc/generic/requirements-elyra.txt --output requirements-elyra.txt && python3 -m pip install packaging && python3 -m pip freeze > requirements-current.txt && python3 bootstrapper.py --pipeline-name 'print_notebook_pythonfile' --cos-endpoint http://10.240.5.123:9099 --cos-bucket kube-secret-test --cos-directory 'print_notebook_pythonfile-0324134407' --cos-dependencies-archive 'python_script-0b0bf262-bc90-4ece-b41b-042f002aef64.tar.gz' --file 'examples/pipelines/setup_validation/python_script.py' "
    ],
